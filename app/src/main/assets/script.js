...
// Mark emergency events older than 2 hours as RESOLVED so stale map markers
// from previous sessions are not redrawn on startup.
function cleanupOldEmergencyEvents() {
    var cutoff = Date.now() - 2 * 60 * 60 * 1000; // 2 h
